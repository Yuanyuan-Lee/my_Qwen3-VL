...
QWEN_STACK_BOWLS_8_V2_VAL = {
    "annotation_path": "/share/project/liyuanyuan/code/Qwen3-VL/qwen3_vl_data_stack_bowls_8_v2/val.json",
    "data_path": "",  # Can be empty if paths are in annotations
}
...
data_dict = {
    ...
    "qwen_stack_bowls_8_v2_val": QWEN_STACK_BOWLS_8_V2_VAL,
}
