...
# 配置
model_path = "./qwen3vl_stack_bowls_8_v2"  # 微调后模型目录
val_file = "/share/project/liyuanyuan/code/Qwen3-VL/qwen3_vl_data_stack_bowls_8_v2/val.json"                 # 验证集路径
device = "cuda" if torch.cuda.is_available() else "cpu"
max_new_tokens = 256
output_file = Path("eval_results/qwen3_vl_data_stack_bowls_8_v2.txt")
