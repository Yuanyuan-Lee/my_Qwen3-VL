        ...
        for sample_idx in range(sample_num):
            ...
            conversation = {
                ...
                "value": f"You are a Aloha-AgileX robot using end-effector control. The instruction is \"{instructions['seen'][instruct_id]}\".<image>\nThis is the left camera image of the current frame.\n<image>\nThis is the head camera image of the current frame.\n<image>\nThis is the right camera image of the current frame.\n"
                        ...
                        f"We define a trajectory label as follows: every {segment_size} frames, take the endpose differences. Each component is mapped to 0 if below the threshold, 1 if within [-threshold, threshold], and 2 if above the threshold. The thresholds for xyz are 0.02, for rpy are 0.05, and for gripper are 0.01.\n"
